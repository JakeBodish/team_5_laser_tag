#######
# Program that simulates 4 players (2 on each team) playing laser tag
# Acts as the client
# Author: Jim Strother
# SOURCE: https://github.com/jstrother123/photon-main/blob/main/udp_files/python_trafficgenarator_v2.py
#######
import socket
import random
import time
